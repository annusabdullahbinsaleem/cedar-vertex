                ...
                <div className="order-1 flex items-center justify-center lg:order-2">
                  <div className="relative mx-auto w-full max-w-[560px]">
                    ...
                    <div className="relative flex items-center justify-center gap-3 sm:gap-4 md:gap-5">
                      <div className="font-display text-[5.5rem] font-black leading-none tracking-[-0.08em] text-white opacity-95 sm:text-[7rem] lg:text-[9rem]">
                        4
                      </div>

                      <div className="relative flex h-28 w-28 items-center justify-center rounded-[2rem] border border-[#00b7d9]/55 bg-[radial-gradient(circle_at_center,_rgba(0,183,217,0.22),rgba(13,17,23,0.92)_58%)] shadow-[0_0_35px_rgba(0,183,217,0.35)] sm:h-36 sm:w-36 md:h-40 md:w-40">
